...
def _io(vadj_single_iostd, vadj_diff_iostd):
    return [
        ...
        # Buttons
        ("user_btn_c", 0, Pins("E18"), vadj_single_iostd),
        ("user_btn_d", 0, Pins("M19"), vadj_single_iostd),
        ("user_btn_l", 0, Pins("M20"), vadj_single_iostd),
        ("user_btn_r", 0, Pins("C19"), vadj_single_iostd),
        ("user_btn_u", 0, Pins("B19"), vadj_single_iostd),

        # Switches
        ("user_sw", 0, Pins("G19"), vadj_single_iostd),
        ("user_sw", 1, Pins("G25"), vadj_single_iostd),
        ("user_sw", 2, Pins("H24"), vadj_single_iostd),
        ("user_sw", 3, Pins("K19"), vadj_single_iostd),
        ("user_sw", 4, Pins("N19"), vadj_single_iostd),
        ("user_sw", 5, Pins("P19"), vadj_single_iostd),
...
class Platform(XilinxPlatform):
    ...
    iostd = {
        1.2: {"diff": IOStandard("LVDS"), "single": IOStandard("LVCMOS12")},
        1.8: {"diff": IOStandard("LVDS_25"), "single": IOStandard("LVCMOS18")},
        2.5: {"diff": IOStandard("LVDS_25"), "single": IOStandard("LVCMOS25")},
        3.3: {"diff": None, "single": IOStandard("LVCMOS33")},
    }

    def __init__(self, fmc1_vadj):
        XilinxPlatform.__init__(
            self,
            device="xc7k325t-ffg900-2", 
            io=_io(
                vadj_single_iostd=self.iostd[fmc1_vadj]["single"],
                vadj_diff_iostd=self.iostd[fmc1_vadj]["diff"]
            ), 
